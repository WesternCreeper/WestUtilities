...
public class DoublyLinkedList
{
    ...
    {
        header = new DoublyLinkedListNode(null, null);
        tail = new DoublyLinkedListNode(null, header);
        header.setNext(tail);
        current = header;
    }
    ...
    */
    ...
    {
        DoublyLinkedListNode newNode = new DoublyLinkedListNode(e);
    ...
    */
    public void retreat()
    {
        if(current != null && (DoublyLinkedListNode)current.back() != header)
        {
    ...
    */
    public void findFirst(Object e)
    {
        DoublyLinkedListNode finder = header;
    ...
    * @param e The object that needs to be found in the linkedlist. If it cannot be found, the position of current is untouched
    */
    public void findLast(Object e)
    {
        DoublyLinkedListNode finder = tail;
        while(finder.back() != header)
        {
            finder = (DoublyLinkedListNode)finder.back();
            Object obj = finder.getObject();
            if(obj != null && obj.equals(e))
            {
                current = finder;
